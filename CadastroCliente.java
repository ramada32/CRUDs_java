...
public class CadastroCliente {
  ...
  private static String[] tmp3 = new String [0];// Ou {}
  ...
  private static void altera() {
  	  ...
  	  System.out.println("digite nome do cliente cadastrado para alterar");
  ...
  private static void remove() {
  	  int j=0;
      System.out.println("digite nome do cliente para remover");
  	  String nomes = sc.next();
  	  String[] tmp3 = new String [names.length - 1];
  	      for(int i = 0;i< names.length;i++){
  	   	       if(names[i] == (nomes)){
               continue;
  ...
  private static void showMenu() {
    ...
    do {
      ...
      say("Menu");
      say("-------------------------");
      say("1 - Criar um novo Cliente");
      say("2 - Altera Nome do Cliente");
      say("3 - Remove Nome do Cliente");
      say("0 - Sair");
      say("-------------------------");
